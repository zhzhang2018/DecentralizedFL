...
class ParameterSharer():
    ...
    def __init__(self, clients, nk, A, R=1.0, share_mode='l', 
                 avg_alg='epsilon', use_rand=False, crs=True, percentage_shared=1, consensus_threshold=0.05, 
...
sharer = ParameterSharer(clients_DFL, nk, Adj, R=R, share_mode=share_mode, avg_alg=avg_alg, 
                         use_rand=use_rand_segmentation, crs=clientwise_rand_segmentation, percentage_shared=pss, 
