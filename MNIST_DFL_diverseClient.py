...
# MNIST_DFL_diverseClient2_dataset_K10_C1_E1_S1.0_M1_V0.7_divk10_case2E1
# lr_list = [1]*K # Case 0 baseline
# lr_list = [1]*(K-1)+[0.1] # Case mild baseline (0 stronger)
# lr_list = [1]*(K//2)+[0.1]*(K-K//2) # Case 1
# lr_list = [0.1]*(K-1)+[1] # Case 2
# lr_list = np.linspace(0.1,1,K) # Case 3
# lr_list = [1]*(K-1)+[1.5] # Case 4
# lr_list = [1]*(K//2)+[1.5]*(K-K//2) # Case 5
# lr_list = [1]*(K-1)+[2.1] # Case 4 stronger
# lr_list = np.linspace(1,1.5,K) # Case 6
# lr_list = np.linspace(1,2.5,K) # Case 6 stronger

# Es = [E]*K # baseline (b
# Es = [E]*(K-1)+[E*2] # Mild baseline (a
# Es = [4*E]*(K//2)+[E]*(K-K//2) # Half normal and half fast (c
# Es = [5*E]*(K-3)+[E,E,E] # Most are faster (d
# Es = np.arange(1,K+1, dtype=int)*E # Continuum 1 to 10 (e
