...
try:
    ...
    for i,cl in enumerate(clients_DFL):
        cl.load_state_dict(torch.load(script_filiename+file_identifier+'_client{}'.format(i)))
else:
    params = None
...
DFL_loss_history, DFL_accuracy_history = train_DFL(AK, clients_DFL, num_rounds=num_rounds, dry_run=False, 
              ...
              past_params=params, save_model_to=script_filiename+file_identifier+'_', bother_saving=10)
