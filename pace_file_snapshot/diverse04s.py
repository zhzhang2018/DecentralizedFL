...
script_filiename = 'MNIST_DFL_diverseClient4s_dataset_K{}_C{}_E{}_S{}_M{}_V{}_'.format(K,C,E*EE,S,Mean,V)
#script_filiename = 'MNIST_DFL_diverseClient4s_dataset_K{}_C{}_E{}_M{}_V{}_'.format(K,C,E*EE,Mean,V)
...
clients_DFL = []
for i in range(K):
    clients_DFL.append(ClientNet(partitioned_dataset[i], B, E, optimizerlr=lr_list[i]))
