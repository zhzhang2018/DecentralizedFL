...
DFL_loss_history, DFL_accuracy_history = train_DFL(AC, clients_DFL, dists, num_rounds=num_rounds, dry_run=False, 
                                                   CK=K, max_n=max_n, 
                             test_loader=test_loader, test_all_client=True,
              num_avg_iter=num_avg_iter, max_num_avg_iter=100, avg_error_thres=0.8,
              past_params=params, save_model_to=script_filename+file_identifier, bother_saving=10, 
              avg_alg='metropolis', avg_weight=0.09)
