...
import utils
S = 0.5 # Fraction of overlapping datapoints. When all agents have full access, you get S = K-1.
...
DFL_loss_history, DFL_accuracy_history = train_DFL(AK, clients_DFL, dists, num_rounds=num_rounds, dry_run=True,#False, 
                                                   CK=K, max_n=max_n, 
